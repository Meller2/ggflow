...
<div class="onb-wrap">
  <div class="glass onb-card">
    ...
    <p class="lead">
      Сейчас поставим движок <b>llama.cpp</b> автоматически и подготовим папку
      для моделей. Ничего вручную скачивать не нужно — файлы лягут рядом с
      программой (portable) или в данные приложения.
    </p>
